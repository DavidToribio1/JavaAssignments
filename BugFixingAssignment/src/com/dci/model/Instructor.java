...
public abstract class Instructor {
	...
	protected int certificationEarned;
	public String[] coursesOffered;
	static public String trainingInstitution = "DCI Resources LLC";
	...
	public void incrementCertificationsEarned() {
		...
		int a = this.certificationEarned++;
	}
	 ...
	 * 
	 */
	static public String describeDCI() {
	...
	public String toString() {
		return "Instructor [name=" + name + ", yearsOfExperience=" + yearsOfExperience + ", hypotheticalSalary="
				+ hypotheticalSalary + ", hypotheticalTax=" + hypotheticalTax + ", email=" + email
				+ ", certificationEarned=" + certificationEarned + ", coursesOffered=" + Arrays.toString(coursesOffered)
				+ "]";
	}
